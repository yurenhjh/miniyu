...
验证 run_a2._oracle_hit_answer/_normalize_answer:
  - 纯文本正确输出 → 命中
...
def test_plain_text_hit():
    ...
    assert run_a2._oracle_hit_answer(a) is True
...
def test_reject_polluted_input():
    ...
    a = "城市：北京北京 天气：未知 温度：—"
    assert run_a2._oracle_hit_answer(a) is False
...
def test_normalize_handles_none_and_empty():
    ...
    assert run_a2._oracle_hit_answer(None) is False
    assert run_a2._oracle_hit_answer("") is False